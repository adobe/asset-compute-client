...
const { AdobeAuth } = require("@nui/adobe-io-events-client");
...
class AssetComputeClient extends EventEmitter {
    ...
    async process(source, renditions, userData) {
        ...
        renditions = renditions.map((rendition, index) => Object.assign({}, rendition, {
            userData: Object.assign({}, rendition.userData, {
                assetComputeClient: {
                    index,
 ...
 * @property {Object} retryOptions Fetch retry options for `@nui/node-fetch-retry` documented here:
 *                                 https://git.corp.adobe.com/nui/node-fetch-retry/blob/master/index.js#L114-L120 (optional)
 */
/**
...
async function createAssetComputeClient(integration, options) {
    ...
    const assetCompute = new AssetCompute(Object.assign({}, options, {
        accessToken,
    ...
    const eventEmitter = new AssetComputeEventEmitter(Object.assign({}, options, {
        accessToken,
        org: integration.technicalAccount.org,
        journal
    }));
